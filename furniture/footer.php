...
<div class="sb_sidebar">
	...
	array(
		...
		"ROOT_MENU_TYPE" => "leftsidebar",
		"USE_EXT" => "N",
		"COMPONENT_TEMPLATE" => "my_menu_left"
	),
	false
);?>
...
<div class="ft_footer">
	...
	array(
		...
		"ROOT_MENU_TYPE" => "footer1row",
		"USE_EXT" => "N",
		"COMPONENT_TEMPLATE" => "my_menu_footer"
	),
	false
);?>
        </div>
            ...
            <p class="vcard">
                ...
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/bitrix/templates/furniture/components/bitrix/phone/phone.php"
                    )
                );?>
                    </span>
